## Github Action使用教程说明(纯自用，好多链接已失效)
...
#### 京东Cookie
  ...
  - 方式二：按`Enter`键换行隔开示例(这里给下三个账号的示例)
    ...
    ```
  - 京东cookie获取看这里
    - [浏览器获取京东cookie教程](https://github.com/orangeade98/jd_scripts_job/blob/master/backUp/GetJdCookie.md) 或者 [插件获取京东cookie教程](https://github.com/orangeade98/jd_scripts_job/blob/master/backUp/GetJdCookie2.md)
